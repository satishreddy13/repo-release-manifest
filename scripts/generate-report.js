...
// ── Sheet writers ─────────────────────────────────────────────────────────────
function writeSummary(wb, sprint, buildInfo, envs, generatedAt) {
...
function writeTeams(wb, teams) {
  ...
  [26, 12, 10, 32, 18, 28, 38, 38].forEach((w, ci) => {
...
async function main() {
  ...
  writeSummary(wbOut, SPRINT, buildInfo, envs, generatedAt);
  writeTeams(wbOut, teams);
